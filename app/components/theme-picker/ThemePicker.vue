...
const neutral = computed({
  ...
  set(option) {
    ...
    window.localStorage.setItem('mhaibaraai.cn-ui-neutral', appConfig.ui.colors.neutral)
  },
})
...
const primary = computed({
  ...
  set(option) {
    ...
    window.localStorage.setItem('mhaibaraai.cn-ui-primary', appConfig.ui.colors.primary)
...
const radius = computed({
  ...
  set(option) {
    ...
    window.localStorage.setItem('mhaibaraai.cn-ui-radius', String(appConfig.theme.radius))
  },
})
...
function setBlackAsPrimary(value: boolean) {
  ...
  window.localStorage.setItem('mhaibaraai.cn-ui-black-as-primary', String(value))
}
</script>

  ...
  setup() {
    ...
    if (import.meta.client) {
      function updateColor(type: 'primary' | 'neutral') {
        const color = localStorage.getItem(`mhaibaraai.cn-ui-${type}`)
        if (color) {
      ...
      function updateRadius() {
        const radius = localStorage.getItem('mhaibaraai.cn-ui-radius')
        if (radius) {
      ...
      function updateBlackAsPrimary() {
        const blackAsPrimary = localStorage.getItem('mhaibaraai.cn-ui-black-as-primary')
        if (blackAsPrimary) {

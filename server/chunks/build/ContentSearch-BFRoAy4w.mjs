...
import { useForwardProps, useForwardPropsEmits, ListboxRoot, ListboxFilter, ListboxContent, ListboxGroup, ListboxGroupLabel, ListboxItem, ListboxItemIndicator, Primitive } from 'reka-ui';
import { V as defu } from '../nitro/nitro.mjs';
import { g as useLocale, y as useContentSearch, z as useColorMode, a as useAppConfig, r as reactivePick, o as omit, t as tv, A as _sfc_main$m, B as transformUI, s as useDebounceFn, v as useKbd, w as useActiveElement, x as useEventListener, h as _sfc_main$u, j as get, k as _sfc_main$v, p as pickLinkProps, m as _sfc_main$w, _ as _sfc_main$A, f as _sfc_main$x, n as _sfc_main$y, q as _sfc_main$h, u as useVModel, b as useFormField, d as useFieldGroup, e as useComponentIcons, l as looseToNumber } from './server.mjs';
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.0_@babel+parser@7.28.3_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_9d4b2e9f87a677038577d18a975a498e/node_modules/@nuxt/ui/dist/runtime/components/Input.vue");
                      ...
                      fn: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ssrRenderSlot(_ctx.$slots, "back", { ui: ui.value }, () => {
                            _push4(ssrRenderComponent(_sfc_main$u, mergeProps({
                                                ...
                                                ssrRenderSlot(_ctx.$slots, item.slot || group.slot || "item", {
                                                  ...
                                                  ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : group.slot ? `${group.slot}-leading` : `item-leading`, {
                                                    ...
                                                    if (item.loading) {
                                                      ...
                                                      _push7(ssrRenderComponent(_sfc_main$y, mergeProps({
                                                  ...
                                                  ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : group.slot ? `${group.slot}-trailing` : `item-trailing`, {
                                                    ...
                                                    if (item.children && item.children.length > 0) {
                                                      ...
                                                      ssrRenderList(item.kbds, (kbd, kbdIndex) => {
                                                        _push7(ssrRenderComponent(_sfc_main$h, mergeProps({
                                                          key: kbdIndex,
                                                  ...
                                                  renderSlot(_ctx.$slots, item.slot || group.slot || "item", {
                                                    ...
                                                    renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : group.slot ? `${group.slot}-leading` : `item-leading`, {
                                                      ...
                                                      item.loading ? (openBlock(), createBlock(_sfc_main$A, {
                                                        ...
                                                        class: ui.value.itemLeadingAvatar({ class: [props.ui?.itemLeadingAvatar, item.ui?.itemLeadingAvatar], active: active || item.active })
                                                      }), null, 16, ["size", "class"])) : item.chip ? (openBlock(), createBlock(_sfc_main$y, mergeProps({
                                                        key: 3,
                                                        size: item.ui?.itemLeadingChipSize || props.ui?.itemLeadingChipSize || ui.value.itemLeadingChipSize(),
                                                        inset: "",
                                                        standalone: ""
                                                    ...
                                                    createVNode("span", {
                                                      ...
                                                      renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : group.slot ? `${group.slot}-trailing` : `item-trailing`, {
                                                        ...
                                                        item.children && item.children.length > 0 ? (openBlock(), createBlock(_sfc_main$A, {
                                                          key: 0,
                                                          name: __props.trailingIcon || unref(appConfig).ui.icons.chevronRight,
                                                          class: ui.value.itemTrailingIcon({ class: [props.ui?.itemTrailingIcon, item.ui?.itemTrailingIcon] })
                                                        ...
                                                        ], 2)) : group.highlightedIcon ? (openBlock(), createBlock(_sfc_main$A, {
                                                          key: 2,
                                                          name: group.highlightedIcon,
                                                          class: ui.value.itemTrailingHighlightedIcon({ class: [props.ui?.itemTrailingHighlightedIcon, item.ui?.itemTrailingHighlightedIcon] })
                                                        }, null, 8, ["name", "class"])) : createCommentVNode("", true)
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.0_@babel+parser@7.28.3_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_9d4b2e9f87a677038577d18a975a498e/node_modules/@nuxt/ui/dist/runtime/components/CommandPalette.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.0_@babel+parser@7.28.3_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_9d4b2e9f87a677038577d18a975a498e/node_modules/@nuxt/ui/dist/runtime/components/content/ContentSearch.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=ContentSearch-BFRoAy4w.mjs.map

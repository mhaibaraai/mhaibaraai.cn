import { _ as _sfc_main$7 } from './Page-qX_INIlN.mjs';
import { M as Motion } from './index-D2ADDnM6.mjs';
import { defineComponent, withAsyncContext, unref, mergeProps, withCtx, createVNode, createBlock, createCommentVNode, openBlock, Fragment, renderList, createTextVNode, toDisplayString, inject, computed, useSlots, renderSlot, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderSlot, ssrRenderClass } from 'vue/server-renderer';
import { F as useAsyncData, G as queryCollection, c as createError, H as useHead, C as _export_sfc, I as ImageComponent, h as _sfc_main$u, a as useAppConfig, t as tv, D as _sfc_main$o, _ as _sfc_main$A, E as getSlotChildrenText, k as _sfc_main$v } from './server.mjs';
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.0_@babel+parser@7.28.3_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_9d4b2e9f87a677038577d18a975a498e/node_modules/@nuxt/ui/dist/runtime/components/PageHero.vue");
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UPageHero = _sfc_main$5;
          ...
          links: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_Motion, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (_ctx.page.hero?.links) {
                      _push3(`<div class="flex items-center gap-2"${_scopeId2}><!--[-->`);
                      ssrRenderList(_ctx.page.hero?.links, (link) => {
                    ...
                    return [
                      _ctx.page.hero?.links ? (openBlock(), createBlock("div", {
                        key: 0,
                        class: "flex items-center gap-2"
                      }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(_ctx.page.hero?.links, (link) => {
...
const __nuxt_component_3 = Object.assign(_sfc_main$4, { __name: "LandingPageHero" });
const theme$1 = {
  "slots": {
    "root": "relative",
    "wrapper": "",
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.0_@babel+parser@7.28.3_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_9d4b2e9f87a677038577d18a975a498e/node_modules/@nuxt/ui/dist/runtime/components/PageFeature.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.0-alpha.0_@babel+parser@7.28.3_@netlify+blobs@9.1.2_change-case@5.4.4_db0@_9d4b2e9f87a677038577d18a975a498e/node_modules/@nuxt/ui/dist/runtime/components/PageSection.vue");
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Motion = Motion;
      const _component_UPageFeature = _sfc_main$3;
        ...
        description: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Motion, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(_ctx.page.section.description)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(_ctx.page.section.description), 1)
                  ];
                }
              }),
              _: 1
          ...
          if (_push2) {
            ...
            ssrRenderList(unref(features), (feature, index) => {
              _push2(ssrRenderComponent(_component_Motion, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_UPageFeature, mergeProps({ ref_for: true }, feature, { orientation: "vertical" }), null, _parent3, _scopeId2));
                  } else {
                    return [
                      createVNode(_component_UPageFeature, mergeProps({ ref_for: true }, feature, { orientation: "vertical" }), null, 16)
                    ];
                  }
                }),
                _: 2
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/landing/PageSection.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_4 = Object.assign(_sfc_main$1, { __name: "LandingPageSection" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "index",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const { data: page } = ([__temp, __restore] = withAsyncContext(() => useAsyncData("landing", () => queryCollection("landing").path("/").first())), __temp = await __temp, __restore(), __temp);
    if (!page.value) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UPage = _sfc_main$7;
      const _component_Motion = Motion;
      const _component_LandingLine = __nuxt_component_2;
      const _component_LandingPageHero = __nuxt_component_3;
      const _component_LandingPageSection = __nuxt_component_4;
      if (unref(page)) {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_Motion, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_LandingLine, null, null, _parent3, _scopeId2));
                  } else {
                    return [
                      createVNode(_component_LandingLine)
                    ];
                  }
                }),
                _: 1
              }, _parent2, _scopeId));
              _push2(ssrRenderComponent(_component_LandingPageHero, { page: unref(page) }, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(_component_LandingPageSection, { page: unref(page) }, null, _parent2, _scopeId));
            } else {
              return [
                createVNode(_component_Motion, {
                  class: "hidden lg:block absolute pb-10 left-0 top-0",
                ...
                createVNode(_component_LandingPageHero, { page: unref(page) }, null, 8, ["page"]),
                createVNode(_component_LandingPageSection, { page: unref(page) }, null, 8, ["page"])
              ];
            }
          }),
          _: 1
...
//# sourceMappingURL=index-DiRIxZeK.mjs.map
